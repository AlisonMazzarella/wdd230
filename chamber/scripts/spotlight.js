...
function displaySpotlightMembers(members) {
    ...
    document.getElementById("spotlight1Email").textContent = spotlight1.number;
    ...
    document.getElementById("spotlight2Email").textContent = spotlight2.number;
    ...
    document.getElementById("spotlight3Email").textContent = spotlight3.number;
}
